...
function hsb2hsl(hsbColor) {
  ...
  0 < b &&
    1 > b &&
    (c =
      (hsbColor.saturation * hsbColor.value) / (0.5 > b ? 2 * b : 2 - 2 * b));
  c = minMax(c, 0, 1);
...
function hsl2hsb(hslColor) {
  var b =
      hslColor.saturation *
      (0.5 > hslColor.lightness ? hslColor.lightness : 1 - hslColor.lightness),
...
function xyz2rgb(xyzColor) {
  ...
  r =
    xyzColor.x * 3.2404542 + xyzColor.y * -1.5371385 + xyzColor.z * -0.4985314;
...
var REDUCED_CHROMA_TOLERANCE = [
  1.762442714, 4.213532634, 7.395827458, 8.07174158, 9.89634504, 11.37591477,
  12.27071136, 13.54160806, 14.35916727, 16.88410864,
];
